...
11:15 & Questions to lecture and multiple-choice questions \\
\hline
11:25 & Today´s exercise and assignment to groups \\
\hline
11:30 & Prepare group presentations – use only 1 trait \\
\hline
11:45 & Group presentations and discussions \\
\hline
12:00 & 15 minutes break \\
\hline
12:15 & Group presentations and discussions  \\
\hline
12:50 & Repeat multiple-choice questions \\
\hline
...
#### Question 3: How many generations and number of mize in each generation do we have in the pedigree?
...
The first element in the `theta` vector is the estimate of the additive genetic variance ($\hat{\sigma}^2_{a}$) and the second element is the estimate of the residual variance ($\hat{\sigma}^2_{a}$). 
...
In the experiment the mize were feed ad libitum. Now we want to perform a simlar experiment where mize are reared under restricted feed intake, We will record phenotypes for body weight and blood glucose levels and use mice from the same F2 population. 

...
If you have problems using `devtools` then use the following

```{r,  eval=TRUE, echo=TRUE}
library(qgg) # R package used for REML/BLUP analysis
source("https://raw.githubusercontent.com/psoerensen/qgg/master/R/compute_grm.R")
source("https://raw.githubusercontent.com/psoerensen/qgg/master/R/genomic_solve.R")
```
...
```{r, fig.align='center', eval=TRUE, echo=T, message=FALSE}
...
```{r, fig.align='center', eval=TRUE, echo=TRUE, message=FALSE}
A <- grm(pedigree=pedigree) 
dim(A)
